  ...
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  ...
  command_interfaces_[0].set_value(rear_left_steer_angle);
  command_interfaces_[1].set_value(rear_right_steer_angle);
  ...
  RCLCPP_INFO_THROTTLE(get_node()->get_logger(), *get_node()->get_clock(), 500,
    ...
    rear_left_steer_angle,
    rear_right_steer_angle);
