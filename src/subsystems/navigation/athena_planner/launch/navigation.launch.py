...
def generate_launch_description():
    ...
    # TODO: Re-enable once localizer is stable.
    ...
    # In sim, the Gazebo bridge publishes the raw ZED cloud; filter it and write
    # to the topic that Nav2 costmaps subscribe to.
    ...
    # On real hardware the ZED wrapper publishes directly; relay to the corrected
    # topic so Nav2 costmaps always see the same topic regardless of sim/real.
