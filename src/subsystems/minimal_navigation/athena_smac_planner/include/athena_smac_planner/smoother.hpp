...
#ifndef ATHENA_SMAC_PLANNER__SMOOTHER_HPP_
#define ATHENA_SMAC_PLANNER__SMOOTHER_HPP_
...
/**
 * @struct athena_smac_planner::BoundaryPoints
...
/**
 * @struct athena_smac_planner::BoundaryExpansion
...
/**
 * @class athena_smac_planner::Smoother
...
public:
  /**
   * @brief A constructor for athena_smac_planner::Smoother
   */
  explicit Smoother(const SmootherParams & params);

  /**
   * @brief A destructor for athena_smac_planner::Smoother
   */
  ~Smoother() {}
...
#endif  // ATHENA_SMAC_PLANNER__SMOOTHER_HPP_
