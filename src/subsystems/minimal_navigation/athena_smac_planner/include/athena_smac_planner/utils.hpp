...
#ifndef ATHENA_SMAC_PLANNER__UTILS_HPP_
#define ATHENA_SMAC_PLANNER__UTILS_HPP_
...
inline double findCircumscribedCost(std::shared_ptr<nav2_costmap_2d::Costmap2DROS> costmap)
{
  ...
  std::shared_ptr<nav2_costmap_2d::InflationLayer> inflation_layer = nullptr;
...
#endif  // ATHENA_SMAC_PLANNER__UTILS_HPP_
