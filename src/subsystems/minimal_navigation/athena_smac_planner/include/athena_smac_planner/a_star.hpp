...
#ifndef ATHENA_SMAC_PLANNER__A_STAR_HPP_
#define ATHENA_SMAC_PLANNER__A_STAR_HPP_
...
#include "athena_smac_planner/thirdparty/robin_hood.h"
#include "athena_smac_planner/analytic_expansion.hpp"
#include "athena_smac_planner/node_hybrid.hpp"
#include "athena_smac_planner/node_basic.hpp"
#include "athena_smac_planner/goal_manager.hpp"
...
/**
 * @class athena_smac_planner::AStarAlgorithm
...
public:
  ...
  /**
   * @struct athena_smac_planner::NodeComparator
  ...
  /**
   * @brief A constructor for athena_smac_planner::AStarAlgorithm
   */
  explicit AStarAlgorithm(const MotionModel & motion_model, const SearchInfo & search_info);

  /**
   * @brief A destructor for athena_smac_planner::AStarAlgorithm
   */
  ~AStarAlgorithm();
...
#endif  // ATHENA_SMAC_PLANNER__A_STAR_HPP_
