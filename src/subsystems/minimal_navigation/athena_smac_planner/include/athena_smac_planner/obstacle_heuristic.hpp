...
#ifndef ATHENA_SMAC_PLANNER__OBSTACLE_HEURISTIC_HPP_
#define ATHENA_SMAC_PLANNER__OBSTACLE_HEURISTIC_HPP_
...
/**
 * @class athena_smac_planner::ObstacleHeuristic
...
public:
  /**
   * @brief A constructor for athena_smac_planner::ObstacleHeuristic
   */
  ObstacleHeuristic() {}

  /**
   * @brief A destructor for athena_smac_planner::ObstacleHeuristic
   */
  ~ObstacleHeuristic() {}
...
#endif  // ATHENA_SMAC_PLANNER__OBSTACLE_HEURISTIC_HPP_
