...
#ifndef ATHENA_SMAC_PLANNER__COLLISION_CHECKER_HPP_
#define ATHENA_SMAC_PLANNER__COLLISION_CHECKER_HPP_

namespace athena_smac_planner
{

/**
 * @class athena_smac_planner::GridCollisionChecker
...
public:
  /**
   * @brief A constructor for athena_smac_planner::GridCollisionChecker
...
#endif  // ATHENA_SMAC_PLANNER__COLLISION_CHECKER_HPP_
